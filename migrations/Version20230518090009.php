...
final class Version20230518090009 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, wca_id VARCHAR(10) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', name VARCHAR(255) NOT NULL, country_iso2 VARCHAR(10) DEFAULT NULL, region VARCHAR(100) DEFAULT NULL, delegate_status VARCHAR(100) DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D64963ED1D03 (wca_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
